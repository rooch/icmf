...
# Category Menu                #
################################
$system->xorg->smarty->assign("categoryMenu", $system->xorg->smarty->fetch($settings[commonTpl] . 'categoryMenu' . $settings['ext4']));
...
# Right Side                   #
################################
$system->xorg->smarty->assign("rightSide", $system->xorg->smarty->fetch($settings[commonTpl] . "rightSide". $settings['ext4']));

################################
# Left Side                    #
################################
$system->xorg->smarty->assign("leftSide", $system->xorg->smarty->fetch($settings[commonTpl] . "leftSide". $settings['ext4']));
