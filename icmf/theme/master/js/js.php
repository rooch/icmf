...
include('../../../kernel/lib/xorg/jQuery/plugin/nivoSlider/jquery.nivo.slider.pack.js');
...
include('../../../kernel/lib/xorg/jQuery/plugin/mansonry/masonry.pkgd.min.js');
...
include('../../../kernel/lib/xorg/jQuery/plugin/jQCloud/jqcloud-1.0.3.min.js');
include('custom.js');
include('startUp.js');
