...
$system->xorg->smarty->assign("postCategory", $system->xorg->htmlElements->treeElement->tree($settings[postCategory], 0, 'postCategory', 'postCategory right specialFont', '`id`=14 OR `id`=18 OR `id`=19 OR (`id` > 26 AND `id` < 37) AND `active` = 1'));
