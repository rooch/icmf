...
$('#itBox').hover(function() {
	$('#itYellowBox').animate({ height:'170px' }, { queue:false, duration:500 });
	$('#itBox').hover(function() {
	}, function() {
		$('#itYellowBox').animate({ height:'20px' }, { queue:false, duration:500 });
	});
});

$('#softwareBox').hover(function() {
	$('#softwareYellowBox').animate({ height:'170px' }, { queue:false, duration:500 });
	$('#softwareBox').hover(function() {
	}, function() {
		$('#softwareYellowBox').animate({ height:'20px' }, { queue:false, duration:500 });
	});
});
