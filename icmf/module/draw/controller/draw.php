...
class c_draw extends m_draw{
	...
	###########################
	// Add Object
	public function c_addObject($name, $category, $description=null){

		$this->m_addObject($name, $category, $description);
	}
	// Edit Object
	...
	// Show Object Random
	public function c_showObjectRandom(){
		$this->m_showObjectRandom();
	}
	// Activate Object
	...
	# Object Details          #
	###########################
	public function c_listDetails($viewMode, $filter = null){
		
		$this->m_listDetails($viewMode, $filter);
	}
	
	public function c_stat(){
