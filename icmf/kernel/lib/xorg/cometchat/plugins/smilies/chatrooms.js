...
(function($){   
	...
	$.ccsmilies = (function () {
        ...
        return {
			...
			init: function (id) {
				baseUrl = getBaseUrl();
				loadCCPopup(baseUrl+'plugins/smilies/index.php?id='+id, 'smilies',"status=0,toolbar=0,menubar=0,directories=0,resizable=0,location=0,status=0,scrollbars=0, width=220,height=200",220,150,'<?php echo $smilies_language[1];?>');  
			},
